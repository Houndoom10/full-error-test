...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_QUILLADIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_BULLETPROOF, ABILITY_NONE, ABILITY_BATTLE_ARMOR },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_BRAIXEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_FOREWARN, ABILITY_NONE, ABILITY_MAGIC_GUARD },
        .bodyColor = BODY_COLOR_RED,
...
#define GRENINJA_MISC_INFO                              \
    ...
    [SPECIES_BUNNELBY] =
    {
        ...
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_HUGE_POWER, ABILITY_CHEEK_POUCH, ABILITY_RUN_AWAY },
    ...
    [SPECIES_DIGGERSBY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_HUGE_POWER, ABILITY_CHEEK_POUCH, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BROWN,
...
#define MEOWSTIC_MISC_INFO                                  \
    ...
    [SPECIES_MEOWSTIC_MALE] =
    {
        MEOWSTIC_MISC_INFO,
        .genderRatio = MON_MALE,
        .abilities = { ABILITY_PRANKSTER, ABILITY_INFILTRATOR, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BLUE,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MEOWSTIC_FEMALE] =
    {
        MEOWSTIC_MISC_INFO,
        .genderRatio = MON_FEMALE,
        .abilities = { ABILITY_COMPETITIVE, ABILITY_INFILTRATOR, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_WHITE,
        .description = COMPOUND_STRING(
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FAIRY, EGG_GROUP_FAIRY },
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_UNBURDEN, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SLURPUFF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FAIRY, EGG_GROUP_FAIRY },
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_UNBURDEN, ABILITY_CHEEK_POUCH },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .abilities = { ABILITY_REFRIGERATE, ABILITY_THICK_FAT, ABILITY_SNOW_WARNING },
        .bodyColor = BODY_COLOR_BLUE,
...
#define GOODRA_MISC_INFO                                        \
    ...
    [SPECIES_PHANTUMP] =
    {
        ...
        .abilities = { ABILITY_HARVEST, ABILITY_FRISK, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_BROWN,
...
,
    ...
    [SPECIES_AVALUGG_HISUIAN] =
    {
        ...
        .abilities = { ABILITY_STURDY, ABILITY_ICE_BODY, ABILITY_TECHNICIAN },
        .height = 14,
        .weight = 2624,
        .description = COMPOUND_STRING(
