...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_FALSE_SURRENDER, MOVE_SPIRIT_BREAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .moves = {MOVE_DOUBLE_EDGE, MOVE_OBSTRUCT, MOVE_NIGHT_SLASH, MOVE_HONE_CLAWS}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 51,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_TRI_ATTACK, MOVE_DARK_PULSE, MOVE_DRACO_METEOR, MOVE_NASTY_PLOT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 51,
    ...
    .moves = {MOVE_CROSS_POISON, MOVE_NIGHT_SLASH, MOVE_ACUPRESSURE, MOVE_X_SCISSOR}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 51,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_KNOCK_OFF, MOVE_TRIPLE_AXEL, MOVE_FAKE_OUT, MOVE_POISON_JAB}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 52,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_AERIAL_ACE, MOVE_SUCKER_PUNCH, MOVE_SWORDS_DANCE, MOVE_NIGHT_SLASH}
    }
};
...
static const struct TrainerMon sParty_Phoebe[] = {
    ...
    .moves = {MOVE_STEALTH_ROCK, MOVE_EARTHQUAKE, MOVE_POLTERGEIST, MOVE_DESTINY_BOND}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 51,
    ...
    .moves = {MOVE_SHADOW_PUNCH, MOVE_MEGA_PUNCH, MOVE_STOMPING_TANTRUM, MOVE_IRON_DEFENSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
    ...
    .moves = {MOVE_WILL_O_WISP, MOVE_SHADOW_BALL, MOVE_INFERNO, MOVE_PAIN_SPLIT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
    ...
    .moves = {MOVE_DRAGON_RUSH, MOVE_PHANTOM_FORCE, MOVE_SUCKER_PUNCH, MOVE_DRAGON_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_DESTINY_BOND, MOVE_SUCKER_PUNCH, MOVE_WILL_O_WISP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SHADOW_SNEAK, MOVE_SHADOW_PUNCH, MOVE_DISABLE, MOVE_PAYBACK}
    }
};
...
static const struct TrainerMon sParty_Glacia[] = {
    ...
    .moves = {MOVE_ICE_SHARD, MOVE_ICE_PUNCH, MOVE_WOOD_HAMMER, MOVE_INGRAIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
    ...
    .moves = {MOVE_DOUBLE_TEAM, MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_DESTINY_BOND}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_HAIL, MOVE_AQUA_JET, MOVE_SUPERPOWER, MOVE_THRASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
    ...
    .moves = {MOVE_BLIZZARD, MOVE_HYPER_BEAM, MOVE_ANCIENT_POWER, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 53,
    ...
    .moves = {MOVE_ICICLE_SPEAR, MOVE_GLAIVE_RUSH, MOVE_DRAGON_DANCE, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 54,
    ...
    .moves = {MOVE_AQUA_RING, MOVE_BRINE, MOVE_BLIZZARD, MOVE_SHEER_COLD}
    }
};
...
static const struct TrainerMon sParty_Drake[] = {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_DUAL_CHOP, MOVE_SLASH, MOVE_NIGHT_SLASH, MOVE_DRAGON_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 53,
    ...
    .moves = {MOVE_BOOMBURST, MOVE_CLANGING_SCALES, MOVE_DRAIN_PUNCH, MOVE_CLANGOROUS_SOUL}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 53,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_CLAW, MOVE_SAND_TOMB, MOVE_SUPERSONIC}
    },
   {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 54,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_EARTHQUAKE, MOVE_DUAL_CHOP, MOVE_DRAGON_DANCE, MOVE_IRON_HEAD}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 54,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_DRAGON_PULSE, MOVE_HYDRO_PUMP, MOVE_THUNDERBOLT, MOVE_FIRE_BLAST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FIRE_FANG, MOVE_DRAGON_CLAW, MOVE_ROCK_SLIDE, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .species = SPECIES_ARON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_METAL_CLAW, MOVE_HARDEN, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 12,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_SAND_ATTACK, MOVE_HARDEN, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 13,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_HARDEN, MOVE_MUD_SHOT, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 14,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_LEER, MOVE_ROCK_THROW, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 14,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GROWL, MOVE_ANCIENT_POWER, MOVE_ICY_WIND, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 16,
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_COMET_PUNCH, MOVE_ARM_THRUST, MOVE_LEER, MOVE_BULK_UP}
    },
     {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 16,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SMASH, MOVE_DETECT, MOVE_BIND, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 17,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LOW_KICK, MOVE_FOCUS_ENERGY, MOVE_ROCK_THROW, MOVE_BULK_UP}
    },
     {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 18,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_VICE_GRIP, MOVE_ROCK_SMASH, MOVE_LEER, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 19,
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_CHARGE, MOVE_QUICK_ATTACK, MOVE_LOW_KICK}
    },
     {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 21,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PARABOLIC_CHARGE, MOVE_CHARM, MOVE_NUZZLE, MOVE_SHOCK_WAVE}
    },
    {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MUD_SHOT, MOVE_SHOCK_WAVE, MOVE_BIDE, MOVE_WATER_GUN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 24,
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_SMOG, MOVE_CONFUSE_RAY, MOVE_FIRE_SPIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 25,
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_FIRE_SPIN, MOVE_CONFUSE_RAY, MOVE_EXTRASENSORY}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 27,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_BITE, MOVE_SMOG, MOVE_ODOR_SLEUTH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 28,
    ...
    .moves = {MOVE_OVERHEAT, MOVE_CLEAR_SMOG, MOVE_BODY_SLAM, MOVE_ATTRACT}
    }
};
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WORK_UP, MOVE_CRUNCH, MOVE_FACADE, MOVE_TAKE_DOWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 27,
    .species = SPECIES_LOUDRED,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_UPROAR, MOVE_FACADE, MOVE_STOMP, MOVE_SUPERSONIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 28,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GLARE, MOVE_DRILL_RUN, MOVE_FACADE, MOVE_YAWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 29,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FEINT_ATTACK, MOVE_SLASH, MOVE_FACADE, MOVE_PLAY_ROUGH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 31,
    .species = SPECIES_VIGOROTH,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SLASH, MOVE_REVERSAL, MOVE_FACADE, MOVE_FEINT_ATTACK}
    }
};
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_DOUBLE_TEAM, MOVE_FOCUS_ENERGY, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 29,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAME_CHARGE, MOVE_AERIAL_ACE, MOVE_AGILITY, MOVE_QUICK_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 30,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLE_KICK, MOVE_FOCUS_ENERGY, MOVE_COPYCAT, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 31,
    ...
    .species = SPECIES_DODRIO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FURY_ATTACK, MOVE_PURSUIT, MOVE_QUICK_ATTACK, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
...
static const struct TrainerMon sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HELPING_HAND, MOVE_FAKE_OUT, MOVE_PSYCHIC, MOVE_REFLECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 40,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STORED_POWER, MOVE_CHARGE_BEAM, MOVE_PSYCHIC, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 40,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_AFTER_YOU, MOVE_DISARMING_VOICE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 40,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_FOLLOW_ME, MOVE_DISARMING_VOICE, MOVE_HELPING_HAND}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 42,
...
static const struct TrainerMon sParty_Juan1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_WATER_PULSE, MOVE_AQUA_RING, MOVE_DRAINING_KISS}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 43,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_PULSE, MOVE_AQUA_JET, MOVE_AURA_SPHERE, MOVE_WATER_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 44,
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_PSYCHIC, MOVE_RECOVER, MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_BEAM, MOVE_CONFUSE_RAY, MOVE_RAIN_DANCE, MOVE_WATER_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 46,
...
static const struct TrainerMon sParty_Wallace[] = {
    ...
    .moves = {MOVE_HYDRO_PUMP, MOVE_RAIN_DANCE, MOVE_HYPNOSIS, MOVE_METRONOME}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 57,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_LIQUIDATION, MOVE_AQUA_JET, MOVE_CLOSE_COMBAT, MOVE_ICE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 57,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_ICE_BEAM, MOVE_HYDRO_PUMP, MOVE_ICE_SHARD, MOVE_HYPER_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PSYCHIC, MOVE_HYDRO_PUMP, MOVE_SLACK_OFF, MOVE_DISABLE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 59,
...
static const struct TrainerMon sParty_WallyVR1[] = {
    ...
    .lvl = 46,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_AERIAL_ACE, MOVE_SAFEGUARD, MOVE_DRAGON_PULSE, MOVE_COTTON_GUARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 46,
    ...
    .moves = {MOVE_PETAL_BLIZZARD, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_TOXIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 46,
    .species = SPECIES_MAGNEZONE,
    .moves = {MOVE_FLASH_CANNNON, MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_SCREECH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 48,
    .species = SPECIES_GALLADE,
    .moves = {MOVE_SLASH, MOVE_SWORDS_DANCE, MOVE_PSYCHO_CUT, MOVE_CLOSE_COMBAT}
    }
};
